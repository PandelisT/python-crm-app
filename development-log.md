...
1. Making client data changes persistent using JSON file - 11/07/2020
...
2. Testing input in the while loops when adding/updating client information through error handling. - 14/07/2020
